...
public class CustomTilesConfigurer implements ServletContextAware, InitializingBean, DisposableBean {
	...
	private static final boolean tilesElPresent =
			ClassUtils.isPresent("org.apache.tiles.el.ELAttributeEvaluator", CustomTilesConfigurer.class.getClassLoader());
	...
	private List<IDefinitionLoader> definitionLoaders;
	...
	/**
	 * @param definitionLoaders the definitionLoaders to set
	 */
	public void setDefinitionLoaders(List<IDefinitionLoader> definitionLoaders) {
	...
	private class SpringTilesContainerFactory extends BasicTilesContainerFactory {
		...
		protected DefinitionsFactory createDefinitionsFactory(ApplicationContext applicationContext,
			...
			if (definitionsFactoryClass != null) {
				...
				if (bw.isWritableProperty("loaders") && definitionLoaders != null) {
					bw.setPropertyValue("loaders", definitionLoaders);
				}
				return factory;
			}
			else {
